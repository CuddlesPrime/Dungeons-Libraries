...
public class MeleeGearConfig {
    ...
    public static final MeleeGearConfig DEFAULT = new MeleeGearConfig(new ArrayList<>(), new ArrayList<>(), ResourceLocation.parse("minecraft:iron"), false, false, false, false, Rarity.COMMON, 1);
